...
import { sanitizeNodeRuntimeEnv, stripUseEnvProxyFromNodeOptions } from './runtime-env.mjs';

test('stripUseEnvProxyFromNodeOptions removes use-env-proxy flags and preserves others', () => {
  assert.equal(
    stripUseEnvProxyFromNodeOptions('--max-old-space-size=2048 --use-env-proxy --trace-warnings'),
