...
const EXTERNAL_PROVIDER_PROFILE_REGISTRY: ProviderProfileDefinition[] = [
  ...
  createImapSmtpProfile({
    ...
    label: '163 IMAP / SMTP',
    summaryHint: '主分类：IMAP / SMTP；服务商：163 邮箱',
  ...
  createImapSmtpProfile({
    ...
    label: '126 IMAP / SMTP',
    summaryHint: '主分类：IMAP / SMTP；服务商：126 邮箱',
  ...
  createImapSmtpProfile({
    ...
    summaryHint: '主分类：IMAP / SMTP；服务商：iCloud',
  ...
  createImapSmtpProfile({
    ...
    summaryHint: '主分类：IMAP / SMTP；服务商：Yahoo',
  ...
  createImapSmtpProfile({
    ...
    summaryHint: '主分类：IMAP / SMTP；服务商：Zoho Mail',
  ...
  createImapSmtpProfile({
    ...
    summaryHint: '主分类：IMAP / SMTP；服务商：阿里邮箱',
  ...
  createImapSmtpProfile({
    ...
    summaryHint: '主分类：IMAP / SMTP；服务商：Amazon WorkMail',
  ...
  createImapSmtpProfile({
    ...
    summaryHint: '主分类：IMAP / SMTP；服务商：Fastmail',
  ...
  createImapSmtpProfile({
    ...
    summaryHint: '主分类：IMAP / SMTP；服务商：AOL Mail',
  ...
  createImapSmtpProfile({
    ...
    provider: 'GMX',
    label: 'GMX IMAP / SMTP',
    summaryHint: '主分类：IMAP / SMTP；服务商：GMX',
  ...
  createImapSmtpProfile({
    ...
    summaryHint: '主分类：IMAP / SMTP；服务商：Mail.com',
  ...
  createImapSmtpProfile({
    ...
    summaryHint: '主分类：IMAP / SMTP；服务商：Yandex Mail',
  ...
  createImapSmtpProfile({
    ...
    summaryHint: '主分类：IMAP / SMTP；服务商：自定义服务器',
