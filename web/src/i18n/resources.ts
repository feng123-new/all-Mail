...
const appResources: Record<AppLanguage, Record<string, string>> = {
  ...
  'api.error.DOMAIN_NOT_EMPTY': '当前域名仍有关联邮箱或消息历史，无法删除。',
  ...
  'api.error.DOMAIN_NOT_EMPTY': 'This domain still has linked mailboxes or message history and cannot be deleted.',
