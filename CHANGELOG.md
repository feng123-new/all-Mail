...
- moved Dashboard single and batch operation-log deletion to the private Go business service with bounded validation and transactionally coupled administrator audit records
